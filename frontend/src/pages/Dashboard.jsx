            ...
            <main className="flex-1 p-8 overflow-y-auto">
                <header className="flex justify-between items-center mb-10">
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold">Welcome, <span className="text-primary-600 dark:text-primary-400">{session?.fullName?.split(' ')[0] || 'Doctor'}</span></h1>
                            <p className="text-slate-700 dark:text-slate-600 dark:text-slate-400">{clinicName}</p>
                        </div>
                    </div>
                    <div className="flex gap-4">
                        <div className="px-5 py-3 glass-card flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-bold">{dailyStats.today_count} Patients</p>
                            </div>
                        </div>
                    ...
                    {showWizard ? (
                        ...
                        >
                            <button
                                ...
                                className="absolute -top-12 right-0 flex items-center gap-2 text-slate-700 dark:text-slate-600 dark:text-slate-500 hover:text-slate-900 dark:text-white transition-colors"
                            >
                                <X className="w-5 h-5" /> Cancel Consultation
                            </button>
                        ...
                        >
                            <button
                                ...
                                className="absolute -top-12 right-0 flex items-center gap-2 text-slate-700 dark:text-slate-500 hover:text-slate-900 dark:text-white transition-colors"
                            >
                                <X className="w-5 h-5" /> Cancel Upload
                            </button>
